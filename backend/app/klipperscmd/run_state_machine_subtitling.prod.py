...
def main():
    print_info("=== Klippers Subtitling Processing State Machine ===")
    ...
    try:
        ...
        for state_machine in response.get('stateMachines', []):
            if state_machine['name'] == 'klippers-subtitling-processing':
                state_machine_arn = state_machine['stateMachineArn']
                break
        
        if not state_machine_arn:
            print_error("ERROR: State machine 'klippers-subtitling-processing' not found")
        ...
        print(f"  aws logs tail /aws/stepfunctions/klippers-subtitling-processing --follow")
        print()

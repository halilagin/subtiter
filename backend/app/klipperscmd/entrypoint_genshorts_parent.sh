...
echo "=== Klipperscmd Fargate Parent Task Starting ==="
echo "Timestamp: $(date)"
...
stderr_path="$VIDEO_WAREHOUSE_ROOT_DIR/$USER_ID/$VIDEO_ID/klippers.parent.stderr"
stdout_path="$VIDEO_WAREHOUSE_ROOT_DIR/$USER_ID/$VIDEO_ID/klippers.parent.stdout"

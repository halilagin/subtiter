...
TASK_INPUT = {
    ...
    "S3_WAREHOUSE_PREFIX": os.environ.get("S3_WAREHOUSE_PREFIX", "klippers_warehouse"),
    ...
    "WEBAPP_API_PORT": os.environ.get("WEBAPP_API_PORT", 80),
    "WEBAPP_API_HOST_FARGATE": os.environ.get("WEBAPP_API_HOST_FARGATE", "klippers.ai"),
    "WEBAPP_API_PORT_FARGATE": os.environ.get("WEBAPP_API_PORT_FARGATE", 80),
...
print(f"{BLUE}FARGATE_TASK_INPUT: {TASK_INPUT}{NC}")

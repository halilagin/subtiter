...
# -*- coding: utf-8 -*-
"""
Python module for triggering Klipperscmd video processing on AWS Fargate via Step Functions.
...
class FargateVideoProcessor:
    ...
    def __init__(
        ...
        state_machine_name: str = "klippers-video-processing-workflow"
    ):
        """
    ...
    def trigger_processing(
        ...
        user_id: str,
        video_id: str,
        video_warehouse_root_dir: str = "/app/klippers_warehouse",

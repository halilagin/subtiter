...
from .model.short_config_model import KlippersShortsConfig, SubtitleConfiguration
import logging
...
def _subtitle_app_embed_subtitles( segment_number: int, subtitle_configuration: SubtitleConfiguration, config: KlippersShortsConfig):
...
def _embed_subtitles(segment_number, config: KlippersShortsConfig):
    """Embeds (hardcodes) subtitles into a video."""
...
def _embed_subtitles_to_video(segment_number, video_file, output_file, config: KlippersShortsConfig, subtitle_configuration: SubtitleConfiguration=None):
...
def _embed_subtitles_to_video_by_subtitle_style(segment_number, input_video, output_video, config: KlippersShortsConfig, subtitle_configuration: SubtitleConfiguration=None):
    if subtitle_configuration is None:
        subtitle_configuration = default_subtitle_configuration

...
def apply_subs_on_ass_file(ass_file, output_file, input_video, config: KlippersShortsConfig, subtitle_configuration: SubtitleConfiguration=None):
    """
...
def _apply_subs_on_ass_file_by_subtitle_style( ass_file, output_file, input_video, config: KlippersShortsConfig, subtitle_configuration: SubtitleConfiguration=None):

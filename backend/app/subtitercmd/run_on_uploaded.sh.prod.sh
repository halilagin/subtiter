...
exec > "$VIDEO_WAREHOUSE_ROOT_DIR/$USER_ID/$VIDEO_ID/subtiter.stdout" 2> "$VIDEO_WAREHOUSE_ROOT_DIR/$USER_ID/$VIDEO_ID/subtiter.stderr"

# Write the PID to a file
echo $$ > "$VIDEO_WAREHOUSE_ROOT_DIR/$USER_ID/$VIDEO_ID/subtiter.pid"

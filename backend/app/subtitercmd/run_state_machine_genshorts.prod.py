...
def main():
    print_info("=== Subtiter Video Processing State Machine ===")
    ...
    try:
        ...
        for state_machine in response.get('stateMachines', []):
            if state_machine['name'] == 'subtiter-video-processing':
                state_machine_arn = state_machine['stateMachineArn']
                break
        
        if not state_machine_arn:
            print_error("ERROR: State machine 'subtiter-video-processing' not found")
        ...
        print(f"  aws logs tail /aws/stepfunctions/subtiter-video-processing --follow")
        print()

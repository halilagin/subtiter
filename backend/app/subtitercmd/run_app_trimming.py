...
from clippercmd.model.short_config_model import SubtiterShortsConfig, TrimConfiguration
...
def _trim_video(segment_number: int, input_video_path: str, output_video_path: str, config: SubtiterShortsConfig, trim_configuration: TrimConfiguration):

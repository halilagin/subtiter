...
"""
Command line tool to post chat messages to the Subtiter chat API endpoint.
"""
...
def send_message(message, room_id, client_id, url, is_testing, conversation_id, verbose):
    """
    Send a chat message to the Subtiter chat API endpoint.
    """
...
def _send_message_to_rest_api(message, room_id, client_id, url, is_testing, conversation_id, verbose):
    ...
    try:
        ...
        print(f"settings.RUN_SUBTITERCMD_ON: {settings.RUN_SUBTITERCMD_ON}")

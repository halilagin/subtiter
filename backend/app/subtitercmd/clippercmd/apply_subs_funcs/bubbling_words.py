...
STYLE_DEFINITION = {
    ...
    "BackColour": "&HFF000000",         # Transparent background
    "Bold": True,
    "Italic": False,
    "Underline": False,
    "StrikeOut": False,
    ...
    "Spacing": 0.0,
    "Angle": 0.0,
    "BorderStyle": 1,                  # Use 1 for outline, 3 for opaque box. Default is outline.
    "Outline": 2.0,
    "Shadow": 0.0,
...
def _create_karaoke_effect(
    ...
    Args:
        ...
        border_thickness: The thickness of the border used to create the rectangle.
    ...
    for duration_str, word_text in matches:
        ...
        # A thick, opaque border is used to simulate a background rectangle.
        # We also switch BorderStyle to 3 to get the opaque box effect.
        active_style = (
            r"\bordstyle3"
            fr"\c{white_color}"
            fr"\fscx100\fscy100"
        ...
        # A transparent border and background effectively removes the rectangle.
        # We also switch BorderStyle back to 1.
        post_active_style = (
            r"\bordstyle1"
            fr"\c{white_color}"
            fr"\fscx100\fscy100"
            fr"\bord{STYLE_DEFINITION['Outline']}"
            fr"\3c{STYLE_DEFINITION['BackColour']}"
            fr"\3a&HFF"  # Make outline transparent as well
            fr"\shad0\be0"
        )

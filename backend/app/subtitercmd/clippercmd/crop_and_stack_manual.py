...
from .model.subtiter_model import BoxRel, RecognizedFacesBBoxes
import ffmpeg
from typing import List, Optional
from .model.subtiter_model import BoxPx
import shutil
from pydantic import BaseModel
from config import  get_shorts_config, settings
from .model.short_config_model import SubtiterShortsConfig
import logging
...
def _crop_and_stack_manual_for_all_faces(input_video_path: str,  output_video_path: str, reference_image_time_interval:int):
    ...
    shorts_config: SubtiterShortsConfig = get_shorts_config()

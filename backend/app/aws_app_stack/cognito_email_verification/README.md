...
- **[API_ENDPOINTS.md](API_ENDPOINTS.md)** - ⭐ **API Documentation** - Registration and confirmation endpoints
...
├── CODE_MAPPING.md                    # How {username} maps to code
├── TEMPLATE_VARIABLES.md              # Template variable details
├── FLOW_DIAGRAM.txt                   # Visual flow diagram
├── scripts/                           # Management scripts
│   ├── confirm_user.py               # Confirm user signups
│   ├── list_cognito_users.py         # List all users
│   └── update_template.sh            # Update email template
└── user_verification_template/       # Email templates
    ├── README.md                     # Template documentation
    ├── email_template.html           # HTML template (default)
    ├── email_template.txt            # Plain text template
    └── verification_template.json    # Legacy JSON format
```
...
**📖 For detailed explanation, see [CODE_MAPPING.md](CODE_MAPPING.md)**
...
**📖 For visual diagram, see [FLOW_DIAGRAM.txt](FLOW_DIAGRAM.txt)**

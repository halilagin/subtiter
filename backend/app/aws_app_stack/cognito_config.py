...
aws_cognito_user_pool_name = "subtiter-user-pool-v2"
region = "eu-west-1"
aws_cognito_user_pool_client_id = "hi8m15u1m02ibeiqroibf3n0i"
aws_cognito_user_pool_client_name = "subtiter-client"
aws_cognito_user_pool_domain = "example-terraform-hosted-ui"
callback_urls = ["https://subtiter.ai/auth-provider/callback"]
logout_urls = ["https://subtiter.ai/auth-provider/logout"]

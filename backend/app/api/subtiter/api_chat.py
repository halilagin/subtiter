...
import os
import traceback
from app.service.subtiter.update_video_status_in_db import _update_video_status_in_db
...
def download_video_files_from_s3(user_id: str, video_id: str):
    ...
    with open(json_file_path, 'r') as f:
        data = json.load(f)
    shorts_config = SubtiterShortsConfig.model_validate(data)
...
def download_trimming_files_from_s3(s3_client: boto3.client, shorts_config: SubtiterShortsConfig, user_id: str, video_id: str):
    pass
    file_names = [
...
def download_subtitling_files_from_s3(s3_client: boto3.client, shorts_config: SubtiterShortsConfig, user_id: str, video_id: str):
    pass
    file_names = [
        "ai_cost_total.json"
    ]
...
def download_genshorts_files_from_s3(s3_client: boto3.client, shorts_config: SubtiterShortsConfig, user_id: str, video_id: str):
    """

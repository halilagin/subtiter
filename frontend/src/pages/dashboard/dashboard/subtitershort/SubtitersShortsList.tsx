...
import SubtiterShortMain from "./SubtiterShortMain";     
import VideoClipSegmentsFlow from "./generatedvideo/VideoClipSegmentsFlow";




const SubtiterShortsListComponent = ({shorts}: {shorts: SchemaUserSegmentVideo[]}) => {
...
interface SubtiterShortsListViewProps {
    videoId: string;
    onClose: () => void;
    onPublish: () => void;
    onEdit: () => void;
...
export const SubtiterShortsListView = ({videoId, onClose, onPublish, onEdit, onDownload}: SubtiterShortsListViewProps) => {
    ...
    return (
        <Box sx={{ 
          ...
          height: '100%'
            ...
            <SubtiterShortsListComponent shorts={shorts} />
        </Box>
    )
}

//8f283f57-9481-49b4-ac0c-9d0fc060015b
export const SubtiterShortsListViewTest = () => {
    return (
        <Box sx={{ 
          bgcolor: '#f5f5f5', 
          minHeight: '100vh',
...
export default SubtiterShortsListView;
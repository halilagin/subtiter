...
export const SubtitlingStyleKaraokePopup: React.FC<SubtitlingStyleProps> = ({ capitalizationStyle, id }) => {
    ...
    useEffect(() => {
      const handleStyleSelected = (event: CustomEvent) => {
        ...
        if (selectedId === id) {
          console.log('SubtitlingStyleKaraokePopup received event with id:', id);
        }
      };

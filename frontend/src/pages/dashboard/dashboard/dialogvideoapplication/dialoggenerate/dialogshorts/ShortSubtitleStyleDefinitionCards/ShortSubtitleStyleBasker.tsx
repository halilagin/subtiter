...
export const ShortSubtitleStyleBasker: React.FC<ShortSubtitleStyleProps> = ({ capitalizationStyle, id }) => {
  ...
  useEffect(() => {
    const handleStyleSelected = (event: CustomEvent<SubtitleConfiguration>) => {
      ...
      if (selectedId === id) {
        console.log('ShortSubtitleStyleBasker received event with id:', id);
      }
    };

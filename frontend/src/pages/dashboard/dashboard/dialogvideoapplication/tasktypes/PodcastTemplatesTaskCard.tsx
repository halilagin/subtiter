...
interface PodcastTemplatesTaskCardProps {
    onClick: () => void;
}


const PodcastTemplatesTaskCard = ({ onClick }: PodcastTemplatesTaskCardProps) => {
            ...
            <CardContent sx={{ p: 2, textAlign: 'center', position: 'relative' }}>
                ...
                >
                    {!gifError ? (
                        <Box
                            component="img"
                            src="/podcast-templates-preview.gif"
                            alt="Podcast Templates Preview"
                        ...
                        >
                            <PodcastsIcon sx={{ fontSize: 48, color: 'text.primary' }} />
                        </Box>
                    )}
                </Box>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ fontSize: '0.75rem', fontFamily: 'Inter, sans-serif' }}>
                    Use professional templates to create podcast videos
                </Typography>
            </CardContent>
        </Card>
    );
...
export default PodcastTemplatesTaskCard;

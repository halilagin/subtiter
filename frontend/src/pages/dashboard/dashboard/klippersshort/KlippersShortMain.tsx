...
interface KlippersShortMainProps {
...
const KlippersShortMain = ({segment, isFirst = false, isLast = false, index = 0}: KlippersShortMainProps) => {
    return (
        <Box 
          id={`short-${index}`}
          sx={{ 
...
export default KlippersShortMain;